...
public class UserValve extends FlagValve {
    ...
    /** The object class. */
    private final UserModel object;

    /**
     * CTOR
     */
    public UserValve(UserModel object) {
     ...
     * 3-激活状态
     */
    public ActiveStateEnum gotActiveState() {
        return super.gotEnumBase(3, ActiveStateEnum.values(), ActiveStateEnum.findDefault());
    }

    public UserValve sotActiveState(ActiveStateEnum value) {
