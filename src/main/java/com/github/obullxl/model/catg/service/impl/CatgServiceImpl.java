 ...
 */
package com.github.obullxl.model.catg.service.impl;
...
import com.github.obullxl.model.catg.dao.impl.AbstractCatgDAO;
 ...
 * 
 * @author obullxl@gmail.com
 * @version $Id: CatgServiceImpl.java, V1.0.1 2014年1月26日 上午9:51:25 $
 */
public class CatgServiceImpl implements TickTimer, CatgService {
    /** Logger */
    ...
    /** 模块分类DAO */
    private AbstractCatgDAO     catgDAO;
    ...
    public void onRefresh() {
        ...
        try {
            // 查询所有
            List<CatgModel> dtos = this.catgDAO.selectAll();
    ...
    /** 
     * @see com.github.obullxl.model.catg.service.CatgService#findByCode(java.lang.String)
     */
    public CatgModel findByCode(String code) {
        return this.catgDAO.selectByCode(code);
    }

    /** 
     * @see com.github.obullxl.model.catg.service.CatgService#findByCatg(java.lang.String)
     */
    public List<CatgModel> findByCatg(String catg) {
        return this.catgDAO.selectByCatg(catg);
    }

    /** 
     * @see com.github.obullxl.lang.catg.CatgService#create(com.github.obullxl.lang.catg.CatgModel)
     */
    ...
    /** 
     * @see com.github.obullxl.lang.catg.CatgService#update(com.github.obullxl.lang.catg.CatgModel)
     */
    public int update(CatgModel catg) {
        int cnt = this.catgDAO.update(catg);

        CatgModel exist = CatgUtils.find(catg.getCode());
    ...
    public int remove(String code) {
        int cnt = this.catgDAO.deleteByCode(code);
        this.onRefresh();
    ...
    public void setCatgDAO(AbstractCatgDAO catgDAO) {
