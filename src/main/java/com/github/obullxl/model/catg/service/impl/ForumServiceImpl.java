 ...
 * 
 * @author obullxl@gmail.com
 * @version $Id: ForumServiceImpl.java, V1.0.1 2014年1月30日 下午4:32:51 $
 */
public class ForumServiceImpl implements ForumService {
    ...
    public void init() {
        ...
        try {
            ForumModel forum = ForumUtils.from(this.catgService.findByCode(CATG));
            if (forum == null) {
                forum = new ForumModel();
                forum.setCode(CATG);
                forum.setTitle("论坛模型保留分类");
                forum.setSummary("论坛模型保留分类，请勿修改！");
                this.catgService.create(ForumUtils.from(forum));
            }
        } catch (Exception e) {
    ...
    /** 
     * @see com.github.obullxl.lang.forum.ForumService#create(com.github.obullxl.lang.ForumModel.ForumModel)
     */
    ...
    /** 
     * @see com.github.obullxl.lang.forum.ForumService#update(com.github.obullxl.lang.ForumModel.ForumModel)
     */
    public void update(ForumModel forum) {
        this.catgService.update(ForumUtils.from(forum));
    }
