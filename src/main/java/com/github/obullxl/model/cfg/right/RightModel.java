 ...
 * 
 * @author obullxl@gmail.com
 * @version $Id: RightModel.java, V1.0.1 2014年1月31日 下午12:59:28 $
 */
public class RightModel extends BaseDTO implements Comparable<RightModel> {
     ...
     */
    public int compareTo(RightModel dst) {
