...
CREATE TABLE atom_user (
  ...
  state 	VARCHAR(10) 	COMMENT '激活状态',
  mngt 		VARCHAR(10) 	COMMENT '管理员后台',
  sex 		VARCHAR(10) 	COMMENT '性别',
  login_state 	VARCHAR(10) 	COMMENT '登录状态',
  email_state 	VARCHAR(10) 	COMMENT '邮箱状态',
  mobile_state 	VARCHAR(10) 	COMMENT '手机状态',
...
INSERT INTO atom_user(no, nick_name, passwd, mobile, email, gmt_create, gmt_modify) VALUES('201401010000000001', "admin", "21218cca77804d2ba1922c33e0151105", "13816241202", "obullxl@163.com", NOW(), NOW());
INSERT INTO atom_user(no, nick_name, passwd, mobile, email, gmt_create, gmt_modify) VALUES('201401010000000002', "老牛啊",  "21218cca77804d2ba1922c33e0151105", "15601656663", "obullxl@gmail.com", NOW(), NOW());
